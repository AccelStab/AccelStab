...
## Getting Started
A more detailed look at the features and background theory of the package can be found in the ['Introduction' vigentte](https://github.com/AccelStab/AccelStab/blob/main/vignettes/Introduction.Rmd), which gives instructions on how to use the package with the available functions and their arguments.
